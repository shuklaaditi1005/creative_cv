export const portfolioData = {
    hero: {
        pageTitle: "Portfolio",
        name: "Aditi Shukla",
        role: "MBA Student & Creator",
        description: "A curious mind creating soft, aesthetic, and user-focused experiences for modern challenges.",
        year: "2026"
    },
    ...
    passions: {
        ...
        paragraphs: [
            ...
            "What motivates me the most is stepping outside my comfort zone, embracing new experiences, and finding opportunities to learn, contribute, and grow with every stage of life."
        ]
    },
    ...
    strengthsWeaknesses: {
        ...
        weakness: {
            label: "Weakness",
            text: "If I had to talk about a weakness, I'd say I sometimes carry setbacks with me longer than I should. Whether it's a difficult conversation or something that didn't go as planned, I tend to replay it in my mind and think about what I could have done differently. While this helps me learn and improve, I'm also learning that not every situation needs to be perfect, and sometimes it's okay to let go and move forward."
        }
    },
